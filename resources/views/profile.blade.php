<x-app-layout title="{{ $user->name }}">
    <div
        class="dark:bg-gray-700 dark:text-gray-300 max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto m-16 bg-white shadow-xl rounded-lg text-gray-900">
        ...
        <div class="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
            <img class="object-cover object-center h-32" src={{ asset('storage/' . $user->avatar) }} alt='user photo'>
        </div>
                                    ...
                                    @foreach ($user->orders as $order)
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                {{ \Carbon\Carbon::parse($order->created_at)->format('M j, Y') }}</td>
                                            ...
                                            <td
                                                class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                <div class="relative flex flex-col justify-center gap-x-2">
                                                    <button
                                                    ...
                                                    <div
                                                        class="products z-50 hidden w-full absolute dark:bg-gray-700 bg-gray-200 p-3 rounded-md top-10">
                                                        @foreach ($order->products as $product)
                                                            <div class="flex items-center mb-2 border-b z-10">
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <span
                                                                        class="text-sm dark:text-gray-300">{{ $product->price }}
                                                                        $</span>
                                                                </div>
                                                            </div>
                                                        @endforeach
